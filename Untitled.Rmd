...
stock_fin_exp <- stock_exp + cum_flow_change(2036)
stock_fin_exp
stock_fin_min <- stock_min + cum_flow_change(2024)
stock_fin_min
stock_fin_max <- stock_max + cum_flow_change(2049)
stock_fin_max
```
...
ggplot(data = stock_year, aes(x = year, y = stock_value)) +
  ...
  labs(x = "Year",
       ...
       title = "Figure 2: California groundwater stock (10^9 m^3), 2000-2050.") +
